...
export default function RegistrarPlan() {
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', paddingTop: '2rem' }}>
      <BackButton fallbackPath='/parametros' fallbackState={{ tab: 'plan' }} title="Registro de Plan Comercial" />

      <div className="card" style={{ padding: '2rem', textAlign: 'center' }}>
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem', color: '#000' }}>Datos del plan comercial</h3>
        ...
        <form onSubmit={handleSave}>
          <div className="form-group" style={{ textAlign: 'left', marginBottom: '1.5rem' }}>
            ...
            <input type="text" className="form-control" name="nombre" placeholder="Nombre Plan Comercial" style={{ fontSize: '1rem' }} required />
          </div>
